  ...
  return (
    <div className="fixed bottom-6 left-6 z-40 flex flex-col gap-3">
      ...
      >
        ...
        <span className="pointer-events-none absolute left-full ml-3 whitespace-nowrap rounded-full bg-navy px-3 py-1.5 text-xs text-on-navy opacity-0 transition-opacity duration-200 group-hover:opacity-100 border border-on-navy-line">
          Chat with us
        </span>
      </a>
